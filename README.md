...
| **Multispectral drone restoration planning** ⭐ *real data* | Own DJI Mavic 3M flights (G/R/RE/NIR), 4 sites in N. Ghana — band registration, NDVI/NDRE, tree-crown delineation, and land→intervention matching (agroforestry / reforestation / ANR) | rasterio + scikit-image + Leaflet |

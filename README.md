...
| **Multispectral drone analysis** ⭐ *real data* | Own DJI Mavic 3M frame (G/R/RE/NIR), N. Ghana — band registration, NDVI/NDRE, tree-crown delineation, afforestation suitability | rasterio + scikit-image + Leaflet |
